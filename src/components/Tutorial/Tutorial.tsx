...
const Tutorial = () => {
  ...
  return (
    ...
    <div className="min-h-screen bg-white py-8 text-gray-800 relative overflow-hidden">
      <Navbar />
    ...
    <div className="container px-4 mx-auto max-w-4xl">
        ...
        <div className="mb-10 text-center">
          ...
          <div className="bg-gradient-to-r from-soft to-white border border-light rounded-lg p-4 mb-8 max-w-2xl mx-auto animate-scale-in shadow-sm">
