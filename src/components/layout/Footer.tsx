...
import { 
  ...
  MessageSquare, 
  Home, 
  GraduationCap, Layers, FileText, Newspaper, List,
...
<div className="grid grid-cols-1 md:grid-cols-3 gap-8 px-6 py-10 bg-white dark:bg-gray-900 transition-colors duration-300">
  ...
  <div className="space-y-5">
    ...
    <div className="flex gap-4 mt-4">
      {[Facebook, Instagram, Twitter, YoutubeIcon].map((Icon, idx) => (
        <a key={idx} href="#" className="text-gray-500 dark:text-gray-400 hover:text-indigo-500 dark:hover:text-indigo-400 transition-colors">
          <Icon size={20} />
        </a>
      ))}
      <a href="https://whatsapp.com/channel/0029Vb62vOn2ER6bd91xQk26" className="text-gray-500 dark:text-gray-400 hover:text-green-500 transition-colors font-bold">W</a>
    </div>
