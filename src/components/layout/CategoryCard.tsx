...
interface CategoryCardProps {
  ...
  const instrumentStyles: Record<string, { color: string, icon: string }> = {
    ...
    'Guitar': { color: 'bg-amber-50 text-amber-700 hover:bg-amber-100', icon: '🎸' },
    'Harp': { color: 'bg-amber-50 text-amber-700 hover:bg-amber-100', icon: '🎻' },
    'Sitar': { color: 'bg-amber-50 text-amber-700 hover:bg-amber-100', icon: '🎻' },
    'Veena': { color: 'bg-amber-50 text-amber-700 hover:bg-amber-100', icon: '🎻' },
    'Banjo': { color: 'bg-amber-50 text-amber-700 hover:bg-amber-100', icon: '🎻' },
    'Flute': { color: 'bg-blue-50 text-blue-700 hover:bg-blue-100', icon: '🎷' },
    'Saxophone': { color: 'bg-blue-50 text-blue-700 hover:bg-blue-100', icon: '🎷' },
    'Trumpet': { color: 'bg-blue-50 text-blue-700 hover:bg-blue-100', icon: '🎺' },
    'Harmonica': { color: 'bg-blue-50 text-blue-700 hover:bg-blue-100', icon: '🎺' },
    'Drum Kit': { color: 'bg-red-50 text-red-700 hover:bg-red-100', icon: '🥁' },
    'Xylophone': { color: 'bg-red-50 text-red-700 hover:bg-red-100', icon: '🥁' },
    'Timpani': { color: 'bg-red-50 text-red-700 hover:bg-red-100', icon: '🥁' },
    'Grand Piano': { color: 'bg-purple-50 text-purple-700 hover:bg-purple-100', icon: '🎹' },
  };
                    ...
                    <DropdownMenuContent align="end" className="w-48 p-2">
                      {instruments.map(instrument => (
                        <DropdownMenuItem key={instrument.id} asChild className={instrumentStyles[instrument.name]?.color || "bg-gray-50 text-gray-700 hover:bg-gray-100"}>
                          <Link to={`/${instrument.id}`} className="flex items-center gap-2 cursor-pointer">
