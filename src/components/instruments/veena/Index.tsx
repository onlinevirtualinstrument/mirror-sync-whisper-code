...
// Veena images for better loading management
const guitarImages = [
  {
    src: "/images/veena/OnlineVirtualVeenaInstrument1.png",
    alt: "Online Virtual Veena Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/veena/OnlineVirtualVeenaInstrument2.png",
    alt: "Online Virtual Veena Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/veena/OnlineVirtualVeenaInstrument3.png",
    alt: "Online Virtual Veena Instrument3",
    // label: "Bass Guitar"
  }
];
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as any).gtag('event', 'page_view', {
        page_title: 'Veena - Virtual Veena Experience',
  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="Play, learn and create music with Veena, a virtual veena experience with multiple veena types and realistic sounds." />
        <meta name="keywords" content="virtual veena, online veena, veena simulator, learn veena" />
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-8 px-4 overflow-x-hidden bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 border-8 border-purple-500/20 border-double rounded-2xl m-4">
        <div className="w-full max-w-screen-xl mx-auto space-y-8">
          ...
          <header className="text-center mb-6 md:mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3 animate-fade-in flex items-center justify-center gap-2" style={{ animationDelay: '0.1s' }}>
              Veena <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Play, customize, and master the veena with AI-powered assistance
            </p>
            ...
            <div className="flex justify-center mt-6 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <button 
                onClick={() => document.getElementById('veena-app')?.scrollIntoView({ behavior: 'smooth' })}
                className="flex items-center gap-2 py-2 text-sm text-muted-foreground hover:text-foreground transition-colors"
                aria-label="Scroll to veena app"
              >
                Start Playing
          ...
          <main id="veena-app" className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
            <Suspense fallback={
              ...
              {selected === 'Guitar 1' && <LazyVeenaComponent />}
              {selected === 'Guitar 2' && <LazyVeenaAdvancedComponent instrumentName="Veena Advanced" />}
            </Suspense>
          </main>
       ...
       <InstrumentInterlink currentInstrument="Veena" />
      </AppLayout>
    </>
  );
};
