...
import InstrumentVariantSelector from '@/components/InstrumentVariantSelector';
      ...
      <div className="flex flex-col items-center">
                ...
                return (
                  <div
                    ...
                    className={`relative cursor-pointer transition-all duration-300 ${
                      activeKey === key.note ? 'transform translate-y-1' : ''
                    }`}
                    onClick={(e) => {
                      playTone(key.note, key.frequency);
        ...
        <p className="text-sm text-gray-600 dark:text-gray-400 mt-4">
          Click on bars or press number keys (1-8) to play notes
           ...
           {/* Instrument Info */}
           <div className="w-full max-w-md mt-6 mb-6 p-4 bg-amber-50/50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
