...
const guitarImages = [
  {
    src: "/images/saxophone/OnlineVirtualSaxophoneInstrument1.png",
    alt: "Online Virtual Saxophone Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/saxophone/OnlineVirtualSaxophoneInstrument2.png",
    alt: "Online Virtual Saxophone Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/saxophone/OnlineVirtualSaxophoneInstrument3.png",
    alt: "Online Virtual Saxophone Instrument3",
    // label: "Bass Guitar"
  }
];
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as any).gtag('event', 'page_view', {
        page_title: 'Saxophone - Virtual Saxophone Experience',
  ...
  return (
    <>
      <Helmet>
        <title>Virtual Saxophone - Interactive Virtual Saxophone Experience | HarmonyHub</title>
        <meta name="description" content="Play, learn and create music with Saxophone, a virtual saxophone experience with multiple saxophone types and realistic sounds." />
        <meta name="keywords" content="virtual saxophone, online saxophone, saxophone simulator, learn saxophone" />
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-8 px-4 overflow-x-hidden bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 border-8 border-purple-500/20 border-double rounded-2xl m-4">
        ...
        {/* <Button variant="outline" className="hover:bg-gray-200" onClick={() => navigate("/")}>
          ...
          <header className="text-center mb-6 md:mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3 animate-fade-in flex items-center justify-center gap-2" style={{ animationDelay: '0.1s' }}>
              Saxophone <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Play, customize, and master the saxophone with AI-powered assistance
            </p>
            ...
            <div className="flex justify-center mt-6 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <button 
                onClick={() => document.getElementById('saxophone-app')?.scrollIntoView({ behavior: 'smooth' })}
                className="flex items-center gap-2 py-2 text-sm text-muted-foreground hover:text-foreground transition-colors"
                aria-label="Scroll to saxophone app"
              >
                Start Playing
          ...
          <main id="saxophone-app" className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
            <Suspense fallback={
              ...
              {selected === 'Guitar 1' && <LazySaxophoneComponent />}
              {selected === 'Guitar 2' && <LazySaxophoneAdvancedComponent instrumentName="Saxophone Advanced" />}
            </Suspense>
          </main>
       ...
       <InstrumentInterlink currentInstrument="Saxophone" />
      </AppLayout>
    </>
  );
};
