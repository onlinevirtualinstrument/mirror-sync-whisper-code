...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as any).gtag('event', 'page_view', {
        page_title: 'Trumpet - Virtual Trumpet Experience',
  ...
  return (
    <>
    <HelmetProvider>
        <title>Virtual Trumpet - Interactive Virtual Trumpet Experience | HarmonyHub</title>
        <meta name="description" content="Play, learn and create music with Trumpet, a virtual trumpet experience with multiple trumpet types and realistic sounds." />
        <meta name="keywords" content="virtual trumpet, online trumpet, trumpet simulator, learn trumpet" />
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-8 px-4 overflow-x-hidden bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 border-8 border-purple-500/20 border-double rounded-2xl m-4">
        ...
        {/* <Button variant="outline" className="hover:bg-gray-200" onClick={() => navigate("/")}>
          ...
          <header className="text-center mb-6 md:mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3 animate-fade-in flex items-center justify-center gap-2" style={{ animationDelay: '0.1s' }}>
              Trumpet <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Play, customize, and master the trumpet with AI-powered assistance
            </p>
            ...
            <div className="flex justify-center mt-6 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <button 
                ...
                aria-label="Scroll to trumpet app"
              >
                Start Playing
          ...
          <main id="trumpet-app" className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
            <Suspense fallback={
              ...
              {selected === 'Guitar 1' && <LazyTrumpetComponent />}
              {selected === 'Guitar 2' && <LazyTrumpetAdvancedComponent instrumentName="Trumpet Advanced" />}
            </Suspense>
          </main>
       ...
       <InstrumentInterlink currentInstrument="Trumpet" />
      </AppLayout>
    </>
  );
};
