...
// Harp images for better loading management
const guitarImages = [
  {
    src: "/images/harp/OnlineVirtualHarpInstrument1.png",
    alt: "Online Virtual Harp Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/harp/OnlineVirtualHarpInstrument2.png",
    alt: "Online Virtual Harp Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/harp/OnlineVirtualHarpInstrument3.png",
    alt: "Online Virtual Harp Instrument3",
    // label: "Bass Guitar"
  }
];
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as any).gtag('event', 'page_view', {
        page_title: 'Harp - Virtual Harp Experience',
  ...
  return (
    <>
      <Helmet>
        <title>Virtual Harp - Interactive Virtual Harp Experience | HarmonyHub</title>
        <meta name="description" content="Play, learn and create music with Harp, a virtual harp experience with multiple harp types and realistic sounds." />
        <meta name="keywords" content="virtual harp, online harp, harp simulator, learn harp" />
        ...
        <div className="w-full max-w-screen-xl mx-auto space-y-8">
          ...
          <header className="text-center mb-6 md:mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3 animate-fade-in flex items-center justify-center gap-2" style={{ animationDelay: '0.1s' }}>
              Harp <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Play, customize, and master the harp with AI-powered assistance
            </p>
            ...
            <div className="flex justify-center mt-6 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <button 
                onClick={() => document.getElementById('harp-app')?.scrollIntoView({ behavior: 'smooth' })}
                className="flex items-center gap-2 py-2 text-sm text-muted-foreground hover:text-foreground transition-colors"
                aria-label="Scroll to harp app"
              >
                Start Playing
          ...
          <main id="harp-app" className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
            <Suspense fallback={
              ...
              {selected === 'Guitar 1' && <LazyHarpComponent/>}
              {selected === 'Guitar 2' && <LazyHarpAdvancedComponent instrumentName="Harp Advanced" />}
            </Suspense>
          </main>
      ...
      <InstrumentInterlink currentInstrument="Harp" />
      </AppLayout>
