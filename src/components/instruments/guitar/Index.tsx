...
const guitarImages = [
  {
    src: "/images/guitar/OnlineVirtualGuitarInstrument1.png",
    alt: "Online Virtual Guitar Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/guitar/OnlineVirtualGuitarInstrument2.png",
    alt: "Online Virtual Guitar Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/guitar/OnlineVirtualGuitarInstrument3.png",
    alt: "Online Virtual Guitar Instrument3",
    // label: "Bass Guitar"
  }
];
  ...
  useEffect(() => {
    ...
    if ('requestIdleCallback' in window) {
      (window as any).requestIdleCallback(() => {
        guitarImages.forEach(image => {
          preloadImage(image.src).catch(() => {
            // Silent catch - don't block rendering for failed preloads
          });
        });
      });
    }
