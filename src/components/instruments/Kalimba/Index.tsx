...
const guitarImages = [
  {
    src: "/images/kalimba/OnlineVirtualKalimbaInstrument1.png",
    alt: "Online Virtual Kalimba Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/kalimba/OnlineVirtualKalimbaInstrument2.png",
    alt: "Online Virtual Kalimba Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/kalimba/OnlineVirtualKalimbaInstrument3.png",
    alt: "Online Virtual Kalimba Instrument3",
    // label: "Bass Guitar"
  }
];
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as any).gtag('event', 'page_view', {
        page_title: 'Kalimba - Virtual Kalimba Experience',
  ...
  return (
    <>
      <Helmet>
        <title>Virtual Kalimba - Interactive Virtual Kalimba Experience | HarmonyHub</title>
        <meta name="description" content="Play, learn and create music with Kalimba, a virtual Kalimba experience with multiple instrument types and realistic sounds." />
        <meta name="keywords" content="virtual Kalimba, online Kalimba, Kalimba simulator, learn Kalimba" />
        ...
        {/* <Button variant="outline" className="hover:bg-gray-200" onClick={() => navigate("/")}>
          ...
          <header className="text-center mb-6 md:mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3 animate-fade-in flex items-center justify-center gap-2" style={{ animationDelay: '0.1s' }}>
              Kalimba <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            Play, customize, and master the kalimba with AI-powered assistance
            </p>
  ...
  `}</style>
          ...
          <main id="banjo-app" className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
            <Suspense fallback={
              ...
              {selected === 'Guitar 1' && <LazyKalimbaComponent/>}
              {selected === 'Guitar 2' && <LazyKalimba2Component />}
            </Suspense>
          </main>
      ...
      <InstrumentInterlink currentInstrument="Kalimba" />
      </AppLayout>
    </>
  );
};
