    ...
    >
      <div className="text-center mb-8">
        <h1 className="text-3xl md:text-4xl font-display font-bold mb-4 animate-fade-in">Virtual Kalimba</h1>
          <div className="text-xs text-muted-foreground bg-purple-50 dark:bg-purple-950/40 border border-purple-200 dark:border-purple-800 rounded-lg px-4 py-2">
            <p>Play the kalimba by clicking on the tines or using number keys (1-9)</p>
          </div>
          <div className="landscape-warning text-xs text-muted-foreground bg-black/5 dark:bg-white/5 p-2 rounded-md mt-4 md:hidden">
