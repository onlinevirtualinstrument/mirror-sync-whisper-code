...
const Index = () => {
  ...
  useEffect(() => {
    // Preload guitar images during idle time
  ...
  return (
    <>
    <HelmetProvider>
        <title>Virtual Violin - Interactive Virtual Violin Experience | HarmonyHub</title>
        <meta name="description" content="Play, learn and create music with Guitar, a virtual guitar experience with multiple instrument types and realistic sounds." />
 ...
 <div className="inline-block mb-2 px-3 py-1 bg-black/5 dark:bg-white/10 rounded-full text-xs font-medium animate-fade-in">
            ...
            Violin <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            Play, customize, and master the violin with AI-powered assistance
            </p>
  ...
  `}</style>
          ...
          <main id="guitar-app" className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
            <Suspense fallback={
              ...
              {selected === 'Guitar 1' && <LazyVirtualViolinComponent />}
              {selected === 'Guitar 2' && <LazyVirtualViolin2Component />}
       ...
       <InstrumentInterlink currentInstrument="Violin" />
      </AppLayout>
    </>
  );
};
