...
const guitarImages = [
  {
    src: "/images/harmonica/OnlineVirtualHarmonicaInstrument1.png",
    alt: "Online Virtual Harmonica Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/harmonica/OnlineVirtualHarmonicaInstrument2.png",
    alt: "Online Virtual Harmonica Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/harmonica/OnlineVirtualHarmonicaInstrument3.png",
    alt: "Online Virtual Harmonica Instrument3",
    // label: "Bass Guitar"
  }
];
