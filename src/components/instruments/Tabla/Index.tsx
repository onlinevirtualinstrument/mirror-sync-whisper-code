...
const guitarImages = [
  {
    src: "/images/tabla/OnlineVirtualTablaInstrument1.png",
    alt: "Online Virtual Tabla Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/tabla/OnlineVirtualTablaInstrument2.png",
    alt: "Online Virtual Tabla Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/tabla/OnlineVirtualTablaInstrument3.png",
    alt: "Online Virtual Tabla Instrument3",
    // label: "Bass Guitar"
  }
];
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as any).gtag('event', 'page_view', {
        page_title: 'Tabla - Virtual Tabla Experience',
  ...
  return (
    <>
    <HelmetProvider>
        <title>Virtual Tabla - Interactive Virtual Tabla Experience | HarmonyHub</title>
        <meta name="description" content="Play, learn and create music with Tabla, a virtual Tabla experience with multiple Tabla types and realistic sounds." />
        <meta name="keywords" content="virtual Tabla, online Tabla, Tabla simulator, learn Tabla" />
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-8 px-4 overflow-x-hidden bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 border-8 border-purple-500/20 border-double rounded-2xl m-4">
        ...
        {/* <Button variant="outline" className="hover:bg-gray-200" onClick={() => navigate("/")}>
          ...
          <header className="text-center mb-6 md:mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3 animate-fade-in flex items-center justify-center gap-2" style={{ animationDelay: '0.1s' }}>
              Tabla <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Play, customize, and master the tabla with AI-powered assistance
            </p>
          ...
          <main id="sitar-app" className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
            <Suspense fallback={
              ...
              {selected === 'Guitar 1' && <LazyTablaComponent/>}
              {selected === 'Guitar 2' && <LazyTablaAdvancedComponent instrumentName="Tabla Advanced" />}
            </Suspense>
          </main>
       ...
       <InstrumentInterlink currentInstrument="Tabla" />
      </AppLayout>
    </>
  );
};
