...
const guitarImages = [
  {
    src: "/images/banjo/OnlineVirtualBanjoInstrument1.png",
    alt: "Online Virtual Banjo Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/banjo/OnlineVirtualBanjoInstrument2.png",
    alt: "Online Virtual Banjo Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/banjo/OnlineVirtualBanjoInstrument3.png",
    alt: "Online Virtual Banjo Instrument3",
    // label: "Bass Guitar"
  }
];
