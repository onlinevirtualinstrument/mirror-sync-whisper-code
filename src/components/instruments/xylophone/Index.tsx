...
const guitarImages = [
  {
    src: "/images/xylophone/OnlineVirtualXylophoneInstrument1.png",
    alt: "Online Virtual Xylophone Instrument1",
    // label: "Acoustic Guitar"
  },
  {
    src: "/images/xylophone/OnlineVirtualXylophoneInstrument2.png",
    alt: "Online Virtual Xylophone Instrument2",
    // label: "Electric Guitar"
  },
  {
    src: "/images/xylophone/OnlineVirtualXylophoneInstrument3.png",
    alt: "Online Virtual Xylophone Instrument3",
    // label: "Bass Guitar"
  }
];
...
const Index = () => {
  ...
  useEffect(() => {
    ...
    if (typeof window !== 'undefined' && 'gtag' in window) {
      (window as any).gtag('event', 'page_view', {
        page_title: 'Xylophone - Virtual Xylophone Experience',
  ...
  return (
    <>
      <Helmet>
        <title>Virtual Xylophone - Interactive Virtual Xylophone Experience | HarmonyHub</title>
        <meta name="description" content="Play, learn and create music with Xylophone, a virtual xylophone experience with multiple xylophone types and realistic sounds." />
        <meta name="keywords" content="virtual xylophone, online xylophone, xylophone simulator, learn xylophone" />
      ...
      <div className="min-h-screen flex flex-col items-center justify-center py-8 px-4 overflow-x-hidden bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 border-8 border-purple-500/20 border-double rounded-2xl m-4">
        ...
        {/* <Button variant="outline" className="hover:bg-gray-200" onClick={() => navigate("/")}>
          ...
          <header className="text-center mb-6 md:mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-3 animate-fade-in flex items-center justify-center gap-2" style={{ animationDelay: '0.1s' }}>
              Xylophone <span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-xl mx-auto animate-fade-in" style={{ animationDelay: '0.2s' }}>
              Play, customize, and master the xylophone with AI-powered assistance
            </p>
            ...
            <div className="flex justify-center mt-6 animate-fade-in" style={{ animationDelay: '0.6s' }}>
              <button 
                onClick={() => document.getElementById('xylophone-app')?.scrollIntoView({ behavior: 'smooth' })}
                className="flex items-center gap-2 py-2 text-sm text-muted-foreground hover:text-foreground transition-colors"
                aria-label="Scroll to xylophone app"
              >
                Start Playing
          ...
          <main id="xylophone-app" className="animate-fade-in" style={{ animationDelay: '0.7s' }}>
            <Suspense fallback={
              ...
              {selected === 'Guitar 1' && <LazyXylophoneComponent/>}
              {selected === 'Guitar 2' && <LazyXylophoneAdvancedComponent instrumentName="Xylophone Advanced" />}
            </Suspense>
          </main>
       ...
       <InstrumentInterlink currentInstrument="Xylophone" />
      </AppLayout>
    </>
  );
};
