...
import { Users, ThumbsUp, Shield, Music, LucideMessageCircleQuestion, Sparkles, Heart, Mail } from "lucide-react";
import { useState } from "react";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { Badge } from '@/components/ui/badge';
import Newsletter, {Unsubscribe, Subscribe} from '@/components/layout/Newsletter';
...
const About = () => {
  ...
  return (
    ...
    >
        ...
        {activeTab === "team" && (
          ...
          >
              ...
              <div className="flex flex-col md:flex-row items-center gap-6">
                <div className="w-full md:w-2/3">
                  ...
                  <p className="text-gray-600 dark:text-gray-300 mb-6">
                    We're always looking for talented individuals who are passionate about music and technology.
                    Check out our current openings and see if there's a role that fits your skills and interests.
                  </p>
                ...
                <div className="w-full md:w-1/3">
                  <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md border border-gray-200 dark:border-gray-700">
                    ...
                    <h4 className="text-lg font-semibold mb-2 text-center">Work With Purpose</h4>
                    <p className="text-gray-600 dark:text-gray-300 text-center text-sm">
                      Join a team that's making a positive impact on music education worldwide
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold mb-6">Our Investors & Partners</h3>
              <div className="flex flex-wrap justify-center gap-8 opacity-60">
                {Array.from({ length: 5 }).map((_, i) => (
                  <div key={i} className="bg-gray-200 dark:bg-gray-700 h-16 w-32 rounded-md flex items-center justify-center">
                    <span className="font-bold text-gray-500 dark:text-gray-300">LOGO</span>
                  </div>
                ))}
              </div>
            </div> */}
      ...
      <div className="grid lg:grid-cols-3 sm:grid-cols-1 gap-4 mx-auto px-4 py-16">
          ...
          {/* <Newsletter variant="default" className="w-full" /> */}
          <Subscribe />
        </div>
