...
const guitarImages = [
  {
    src: "https://images.unsplash.com/photo-1605020420620-20c943cc4669?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    alt: "Acoustic Guitar",
    label: "Acoustic Guitar"
  },
  {
    src: "https://images.unsplash.com/photo-1550291652-6ea9114a47b1?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    alt: "Electric Guitar",
    label: "Electric Guitar"
  },
  {
    src: "https://images.unsplash.com/photo-1445985543470-41fba5c3144a?ixlib=rb-4.0.3&auto=format&fit=crop&w=500&q=80",
    alt: "Bass Guitar",
    label: "Bass Guitar"
  }
];
...
<>
    <Helmet>
      ...
      <div className="mt-4 min-h-screen flex flex-col items-center justify-center  overflow-x-hidden bg-gradient-to-b from-white to-gray-50 dark:from-gray-900 dark:to-gray-950 border-8 border-purple-500/20 border-double rounded-2xl ">
        <div className="w-full max-w-screen-xl mx-auto space-y-8">
          ...
          <header className="text-center mb-6 mt-6 md:mb-12">
            ...
            Interactive Piano<span className="bg-gradient-to-r from-purple-500 to-blue-500 bg-clip-text text-transparent">Studio</span>
            ...
            <div className="flex flex-wrap justify-center gap-2 mt-4 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              ...
              <div className="flex items-center text-sm text-muted-foreground bg-white/80 dark:bg-gray-800/80 shadow-sm px-3 py-1.5 rounded-full">
                <Piano className="w-4 h-4 mr-1.5" />
                Multiple Piano Types
              </div>
              <div className="flex items-center text-sm text-muted-foreground bg-white/80 dark:bg-gray-800/80 shadow-sm px-3 py-1.5 rounded-full">
            ...
            <div className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-4 max-w-4xl mx-auto animate-fade-in" style={{ animationDelay: '0.4s' }}>
    ...
    <div className="container mx-auto p-4 py-10">
      ...
      `}</style>
      <div className={`piano-container rounded-lg overflow-hidden shadow-xl p-4 ${
